...
# Define the topic for research and content creation
topic = "Medical Industry using Generative AI"

# Tool 1: Language Model
...
senior_research_analyst = Agent(
    ...
    backstory=(
        ...
        "You're skilled at distinguishing reliable sources from unreliable ones, fact-checking, cross-referencing information, "
...
research_task = Task(
    description=(
        f"""
        1. Conduct comprehensive research on the topic: "{topic}", including:
